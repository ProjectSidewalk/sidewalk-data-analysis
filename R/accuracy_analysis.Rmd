...
This section has a series of boxplots that compare performance of anonymous volunteers, registered volunteers, and turkers. Here, turker means just a single turker (the first turker to complete each set of routes).
