...
c <- c(replicate(6, 'factor'), 'numeric', 'numeric', 'logical', 'logical', replicate(3, 'factor'),
       replicate(8, 'numeric'))
...
```{r low-severity-raw-accuracy, echo=FALSE, fig.height=6, fig.width=8}
...
```{r low-severity-recall, echo=FALSE, fig.height=6, fig.width=8}
...
```{r low-severity-precision, echo=FALSE, fig.height=6, fig.width=8}
...
```{r low-severity-f-measure, echo=FALSE, fig.height=6, fig.width=8}
...
```{r low-severity-specificity, echo=FALSE, fig.height=6, fig.width=8}
