...
```{r turk.user.behavior.analysis.correlation.tests.fits, echo=FALSE, fig.width=2.5, fig.height=4}
...
```{r turk.user.behavior.analysis.correlation.tests.1, echo=FALSE, fig.width=2.5, fig.height=2.5}
ggplot(data = turk.behavior.corr.test.data %>% filter(accuracy.type == 'recall'),
...
```{r turk.user.behavior.analysis.correlation.tests.spearman, echo=FALSE, fig.width=2.5, fig.height=5}
...
freq.rec.test.p <- cor.test(turk.behavior.rec$labels.per.100m, turk.behavior.rec$accuracy.value, method = 'pearson')


freq.rec.test.k <- Kendall(turk.behavior.rec$labels.per.100m, turk.behavior.rec$accuracy.value)
speed.rec.test.k <- Kendall(turk.behavior.rec$meters.per.min, turk.behavior.rec$accuracy.value)
freq.prec.test.k <- Kendall(turk.behavior.prec$labels.per.100m, turk.behavior.prec$accuracy.value)
speed.prec.test.k <- Kendall(turk.behavior.prec$meters.per.min, turk.behavior.prec$accuracy.value)
freq.speed.test.k <- Kendall(turk.behavior.rec$labels.per.100m, turk.behavior.rec$meters.per.min)

# Note: cor.test defaults to Pearson coefficient
freq.rec.test.p <- cor.test(turk.behavior.rec$labels.per.100m, turk.behavior.rec$accuracy.value)
speed.rec.test.p <- cor.test(turk.behavior.rec$meters.per.min, turk.behavior.rec$accuracy.value)
freq.prec.test.p <- cor.test(turk.behavior.prec$labels.per.100m, turk.behavior.prec$accuracy.value)
speed.prec.test.p <- cor.test(turk.behavior.prec$meters.per.min, turk.behavior.prec$accuracy.value)
freq.speed.test.p <- cor.test(turk.behavior.rec$labels.per.100m, turk.behavior.rec$meters.per.min)

first.var <- c('frequency', 'speed', 'frequency', 'speed', 'frequency')
second.var <- c('recall', 'recall', 'precision', 'precision', 'speed')
r <- c(freq.rec.test.p$estimate, speed.rec.test.p$estimate, freq.prec.test.p$estimate, speed.prec.test.p$estimate, freq.speed.test.p$estimate)
p.val.r <- c(freq.rec.test.p$p.value, speed.rec.test.p$p.value, freq.prec.test.p$p.value, speed.prec.test.p$p.value, freq.speed.test.p$p.value)
tau <- c(freq.rec.test.k$tau, speed.rec.test.k$tau, freq.prec.test.k$tau, speed.prec.test.k$tau, freq.speed.test.k$tau)
p.val.tau <- c(freq.rec.test.k$sl[1], speed.rec.test.k$sl[1], freq.prec.test.k$sl[1], speed.prec.test.k$sl[1], freq.speed.test.k$sl[1])
