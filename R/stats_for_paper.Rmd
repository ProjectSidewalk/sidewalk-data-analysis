...
```{r reading.cleaning.turk.data, echo=FALSE, include=FALSE}
...
TODO total missions by user group <br>
TODO total distance by user group <br>
...
A total of `r n.turkers` turkers, `r n.reg` registered users, and `r n.anon` anonymous users are part of this study.
