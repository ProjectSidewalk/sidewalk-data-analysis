...
quadrant.distro.data <-
  ...
  gather(key = 'user_group', value = 'distribution', 'Anonymous Users', 'Registered Users', DC) %>%
  mutate(user_group = factor(user_group, levels = c('DC', 'Registered Users', 'Anonymous Users')),
