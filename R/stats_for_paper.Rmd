...
labels %>%
  ...
  count(label_type_id) %>%
  mutate(label_type = label.type.mapping[label_type_id]) %>%
  select(label_type, n) %>%
...
TODO: Number of labels (only high quality users)<br>
TODO: labels by label type<br>
TODO: number of audits<br>
TODO: anything else?
