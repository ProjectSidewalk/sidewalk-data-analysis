...
plot.dropoffs <- function(users.remaining.data, dropoff.step.labels, use.percentages) {
  if (use.percentages) {
...
plot.dropoffs.split <- function(users.remaining.split.data, dropoff.step.labels, use.percentages) {
  if (use.percentages) {
    y.lab <- 'Users Remaining (%)'
    max.users <-
...
step.labels <- c('Start tutorial',
                 ...
                 'Fifth curb ramp',
                 'Finish tutorial')
plot.dropoffs(users.remaining.tutorial, step.labels, FALSE)
plot.dropoffs.split(users.remaining.tutorial.split, step.labels, FALSE)
```
...
dropoff.labels <- c('Finish tutorial',
                    ...
                    '9 missions',
                    '10 missions')
plot.dropoffs(users.remaining.post.tutorial, dropoff.labels, FALSE)
plot.dropoffs.split(users.remaining.post.tutorial.split, dropoff.labels, FALSE)
```
...
plot.dropoffs(users.remaining.all, combined.dropoff.labels, FALSE)
plot.dropoffs.split(users.remaining.all.split, combined.dropoff.labels, FALSE)
plot.dropoffs(users.remaining.all, combined.dropoff.labels, TRUE)
plot.dropoffs.split(users.remaining.all.split, combined.dropoff.labels, TRUE)
```
