...
kable(
  turk.study.summary.stats.with.labels %>%
    ...
    dplyr::summarize(
      lab.p.100m.mn = mean(labels.per.100m, na.rm = TRUE),
      lab.p.100m.md = median(labels.per.100m, na.rm = TRUE),
      lab.p.100m.std = sd(labels.per.100m, na.rm = TRUE),
      m.p.min.mn = mean(meters.per.min, na.rm = TRUE),
      m.p.min.md = median(meters.per.min, na.rm = TRUE),
      m.p.min.sd = sd(meters.per.min, na.rm = TRUE),
      min.audited.mn = mean(minutes_audited, na.rm = TRUE),
      min.audited.md = median(minutes_audited, na.rm = TRUE),
      min.audited.sd = sd(minutes_audited, na.rm = TRUE),
      sec.to.label.mn = mean(seconds.to.label, na.rm = TRUE),
      sec.to.label.md = median(seconds.to.label, na.rm = TRUE),
