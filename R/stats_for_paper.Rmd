...
kable(
  filtered.speeds %>%
    ...
    dplyr::summarise(
      ...
      minutes.audited.sd = sd(minutes_audited, na.rm = TRUE),
      m.per.min = median(m_per_min, na.rm = TRUE),
      m.per.min.sd = sd(m_per_min[m_per_min = Inf], na.rm = TRUE),
      labels = median(label_count, na.rm = TRUE),
      label.per.100m = median(labels_per_100m, na.rm = TRUE),
      labels.per.100m.sd = sd(labels_per_100m, na.rm = TRUE),
...
kable(
  turk.study.summary.stats.with.labels %>%
    ...
    dplyr::summarize(
      lab.p.100m = median(labels.per.100m, na.rm = TRUE),
      lab.p.100m.std = sd(labels.per.100m, na.rm = TRUE),
      m.p.min = median(meters.per.min, na.rm = TRUE),
      m.p.min.sd = sd(meters.per.min, na.rm = TRUE),
      min.audited = median(minutes_audited, na.rm = TRUE),
      min.audited.sd = sd(minutes_audited, na.rm = TRUE),
      sec.to.label = median(seconds.to.label, na.rm = TRUE),
      sec.to.label.sd = sd(seconds.to.label, na.rm = TRUE)
    ),
  digits = 3,
  align = 'l'
  )
...
turk.showing.stats.4.and.5 <-
  turk.study.summary.stats %>%
    ...
    dplyr::summarize(
      all.rec = mean(all.recall, na.rm = TRUE),
      all.rec.sd = sd(all.recall, na.rm = TRUE),
      all.prec = mean(all.precision, na.rm = TRUE),
      all.prec.sd = sd(all.precision, na.rm = TRUE),
      all.f = mean(all.f.measure, na.rm = TRUE),
      all.f.sd = sd(all.f.measure, na.rm = TRUE),
      prob.rec = mean(prob.recall, na.rm = TRUE),
      prob.rec.sd = sd(prob.recall, na.rm = TRUE),
      prob.prec = mean(prob.precision, na.rm = TRUE),
      prob.prec.sd = sd(prob.precision, na.rm = TRUE),
      prob.f = mean(prob.f.measure, na.rm = TRUE),
