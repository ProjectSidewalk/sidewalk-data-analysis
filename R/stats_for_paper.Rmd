...
kable(
  ...
  digits = 3,
  align = 'l',
  caption = 'Median accuracy across all users - street level'
  )
kable(
  all.type.accuracy.data %>%
  ...
  digits = 3,
  align = 'l',
  caption = 'Median accuracy across all users - 5 meter level'
  )
```
...
kable(
  ...
  digits = 3,
  align = 'l',
  caption = 'Median accuracy by user group - street level'
  )
kable(
  turk.showing.stats.2 %>%
    filter(granularity == '5_meter') %>%
  ...
  digits = 3,
  align = 'l',
  caption = 'Median accuracy by user group - 5 meter level'
  )
```
