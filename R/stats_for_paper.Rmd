...
format.tukey.table <- function(tukey, outcome.var, fixed.var, test.data, descending = FALSE) {
...
Recall, all label types: Likelihood ratio = `r format(lrt.user.group.recall.all['worker.type','LRT'], digits = 5)`, `r print.p.value(lrt.user.group.recall.all['worker.type','Pr(Chi)'])`
...
Precision, all label types: Likelihood ratio = `r format(lrt.user.group.prec.all['worker.type','LRT'], digits = 5)`, `r print.p.value(lrt.user.group.prec.all['worker.type','Pr(Chi)'])`
...
Recall, Problem type: Likelihood ratio = `r format(lrt.user.group.recall.prob['worker.type','LRT'], digits = 5)`, `r print.p.value(lrt.user.group.recall.prob['worker.type','Pr(Chi)'])`
...
Precision, Problem type: Likelihood ratio = `r format(lrt.user.group.prec.prob['worker.type','LRT'], digits = 5)`, `r print.p.value(lrt.user.group.prec.prob['worker.type','Pr(Chi)'])`
