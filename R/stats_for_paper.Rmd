...
kable(
  turk.study.summary.stats %>%
    ...
    dplyr::summarize(
      ...
      all.precision = median(all.precision, na.rm = TRUE),
      all.f.measure = median(all.f.measure, na.rm = TRUE),
      all.n = median(all.n, na.rm = TRUE),
      prob.recall = median(prob.recall, na.rm = TRUE),
      prob.precision = median(prob.precision, na.rm = TRUE),
      prob.f.measure = median(prob.f.measure, na.rm = TRUE),
